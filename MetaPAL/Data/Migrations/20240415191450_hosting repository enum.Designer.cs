...
namespace MetaPAL.Data.Migrations
{
    ...
    [Migration("20240415191450_hosting repository enum")]
    partial class hostingrepositoryenum
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MetaPAL.Models.Experiment", b =>
                {
                    ...
                    b.Property<int?>("ExperimentMetaDataId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("ExperimentMetaDataId");

                    b.ToTable("Experiments");
                });

            modelBuilder.Entity("MetaPAL.Models.ExperimentMetaData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ExperimentMetaData");
                });

            modelBuilder.Entity("MetaPAL.Models.ProteomicsQuantificationResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProteomicsQuantificationResult");
                });

            modelBuilder.Entity("MetaPAL.Models.ProteomicsSearchResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProteomicsSearchResult");
                });

            modelBuilder.Entity("MetaPAL.Models.Repo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DatasetFtpLocation")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Description")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("HostingRepository")
                        .HasColumnType("int");

                    b.Property<string>("HostingRepositoryURL")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MetaPAL.Models.SampleMetaData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("BiologicalReplicate")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("SamplePreparationBatch")
                        .HasColumnType("int");

                    b.Property<int?>("TechnicalReplicate")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MetaPAL.Models.Experiment", b =>
                {
                    b.HasOne("MetaPAL.Models.ExperimentMetaData", "ExperimentMetaData")
                        .WithMany()
                        .HasForeignKey("ExperimentMetaDataId");

                    b.Navigation("ExperimentMetaData");
                });

            modelBuilder.Entity("MetaPAL.Models.ProteomicsQuantificationResult", b =>
                {
                    b.HasOne("MetaPAL.Models.Experiment", null)
                        .WithMany("ProteomicsQuantificationResults")
            ...
            modelBuilder.Entity("MetaPAL.Models.ProteomicsSearchResult", b =>
                {
                    b.HasOne("MetaPAL.Models.Experiment", null)
                        .WithMany("ProteomicsSearchResults")
                        .HasForeignKey("ExperimentId");
                });
            ...
            modelBuilder.Entity("MetaPAL.Models.Experiment", b =>
                {
                    b.Navigation("ProteomicsQuantificationResults");

                    b.Navigation("ProteomicsSearchResults");
                });
